...
SEGMENTS = [
    ("card", "CARD", "장관 후보자가 청문회도 못 가고 지명 14일 만에 사퇴함"),
    ("s01", "WHITE", "용혜인 성평등가족부 장관 후보자 얘기인데"),
    ("s02", "YELLOW", "이재명 정부 들어 벌써 네 번째 낙마임"),
    ("s03", "WHITE", "앞의 셋은 청문회라도 거쳤는데"),
    ("ad1", "WHITE", "이번엔 청문회 문턱도 못 밟음"),
    ("s04", "WHITE", "비례대표 의원직 겸직이랑"),
    ("s05", "YELLOW", "기본소득당 사당화 논란이 계속 붙었고"),
    ("s06", "YELLOW", "청와대는 파리에서 청문회 거치라더니"),
    ("s07", "PINK", "엿새 만에 후보자가 먼저 물러난 셈임"),
    ("s08", "WHITE", "추천 검증 지명 나눠 맡는 인사위원회가 안 돌아갔다는 지적에"),
    ("ad2", "WHITE", "책임진 사람은 아직 아무도 없음"),
    ("s10", "YELLOW", "박지원도 비난이 대통령한테 가면 인사 라인 책임이라 했음"),
    ("s11", "WHITE", "근데 14일부터 청문회가 줄줄이라"),
    ("s12", "YELLOW", "전전세 의혹 대법관 갭투자 의혹 부총리 후보까지 남았음"),
    ("s14", "RED", "근데 솔직히 검증을 안 한 건지 못 한 건지 모르겠음"),
]
